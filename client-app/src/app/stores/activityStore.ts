...
export default class ActivityStore{
    ...
    //The Map is initialized with a filter to show all activities
    ...
    constructor(){
        ...
        //This reaction will execute when keys in the predicate change because the user updates the actitvity filters
        reaction(
            ()=>this.predicate.keys(),
            ()=>{
